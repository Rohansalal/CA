        ...
        <header className="bg-white border-b border-slate-200 h-16 px-6 flex items-center justify-between shrink-0 sticky top-0 z-40">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center relative">
              ...
              {isSearchFocused && (
                <div className="absolute top-full mt-2 w-64 bg-white border border-slate-200 rounded-lg shadow-lg z-50">
                  <div className="p-4 text-sm text-slate-500">
                    {/* Placeholder for search results/suggestions */}
                    <p>Type to search for clients, services, or documents...</p>
                    <ul className="mt-2 space-y-1">
                      <li className="p-2 hover:bg-slate-50 rounded-md cursor-pointer">Recent Search: "GST Filing"</li>
                      <li className="p-2 hover:bg-slate-50 rounded-md cursor-pointer">Suggestion: "New Client Onboarding"</li>
                    </ul>
                  </div>
                </div>
              )}
                ...
                <div className="max-h-60 overflow-y-auto">
                  <DropdownMenuItem className="flex items-start gap-3 py-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">New client "John Doe" registered.</p>
                  ...
                  <DropdownMenuItem className="flex items-start gap-3 py-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">Payment received from "Jane Smith".</p>
                  ...
                  <DropdownMenuItem className="flex items-start gap-3 py-3">
                    ...
                    <div className="flex-1">
                      <p className="text-sm font-medium">Task "Review ITR" is overdue.</p>
                      <p className="text-xs text-slate-500">Yesterday</p>
                    </div>
                  </DropdownMenuItem>
                  <DropdownMenuItem className="flex items-start gap-3 py-3 text-center justify-center text-blue-600">
