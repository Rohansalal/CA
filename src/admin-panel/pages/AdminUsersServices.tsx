      ...
      <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <CardContent className="p-6">
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Button 
                      className="h-11 px-6 rounded-xl font-bold text-xs bg-slate-900 text-white hover:bg-slate-800 shadow-sm transition-all"
                      onClick={fetchUsers}
                    >
                      Search Users
                    </Button>
                          ...
                          <tr key={user.id} className="group hover:bg-slate-50/50 transition-all duration-200">
                            ...
                            <td className="px-8 py-5">
                              <Badge variant="outline" className={cn(
                                ...
                                user.role === "ADMIN" ? "bg-slate-700 text-white border-slate-700" :
                      ...
                      {Array.from({ length: usersPagination.pages }, (_, i) => (
                        <Button 
                          ...
                          className={cn(
                            ...
                            usersPagination.page === i + 1 ? "bg-slate-900 text-white shadow-sm" : "text-slate-500 hover:bg-white"
                          )}
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between bg-white p-4 sm:p-6 rounded-2xl border-2 border-slate-200 shadow-sm gap-3 sm:gap-4">
              ...
              <Button
                ...
                className="h-10 sm:h-11 px-4 sm:px-6 rounded-xl font-black text-xs bg-slate-900 text-white hover:bg-slate-800 shadow-sm transition-all w-full sm:w-auto"
              >
              ...
              <CardContent className="p-4 sm:p-6 md:p-10 pt-0">
                <form onSubmit={handleServiceSubmit} className="space-y-5 sm:space-y-6 md:space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-4 sm:pt-6">
                    ...
                    <Button type="submit" className="flex-1 sm:flex-[2] h-12 sm:h-14 md:h-16 rounded-xl sm:rounded-2xl font-black text-[11px] uppercase tracking-widest bg-slate-900 text-white border-2 border-slate-900 hover:bg-slate-800 shadow-sm order-1 sm:order-2">Commit Changes</Button>
                  </div>
                </form>
              </CardContent>
            </Card>
        ...
        {isPlansModalOpen && selectedServiceForPlans && (
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-white/90 backdrop-blur-md p-2 sm:p-4 md:p-6 animate-in fade-in duration-300">
            <Card className="w-full max-w-[98vw] md:max-w-[90vw] h-[95vh] sm:h-[90vh] rounded-2xl sm:rounded-[2rem] md:rounded-[3rem] border-2 border-slate-900 shadow-2xl flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
              <CardHeader className="p-4 sm:p-6 md:p-10 pb-3 sm:pb-4 md:pb-6 flex flex-col sm:flex-row sm:items-center justify-between shrink-0 bg-white gap-3 sm:gap-4">
                ...
                <div className="flex gap-2 sm:gap-3 shrink-0">
                  ...
                  <Button
                    ...
                    className="h-10 sm:h-12 md:h-14 px-4 sm:px-6 md:px-10 rounded-xl sm:rounded-2xl font-black text-[9px] sm:text-[10px] uppercase tracking-widest bg-slate-900 text-white border-2 border-slate-900 hover:bg-slate-800 shadow-sm"
                  >
                      ...
                      {plans.map((plan, index) => (
                              ...
                              {plan.scopes?.map((scope, sIdx) => (
                                <div key={scope.id || `scope-${sIdx}`} className="flex items-center gap-1.5 sm:gap-2.5 p-1.5 sm:p-2 bg-slate-50/50 border border-slate-100 rounded-lg group/item hover:bg-white hover:border-slate-200 transition-all">
                                  ...
                                  <Button
                                    variant="ghost"
                                    size="icon"
                                    className="h-5 w-5 rounded-md opacity-100 sm:opacity-0 group-hover/item:opacity-100 text-red-600 hover:bg-red-50 transition-opacity shrink-0"
                                    onClick={() => {
                                      const newPlans = [...plans];
                        ...
                        <div className="p-3 sm:p-4 md:p-5 bg-slate-50 border-t border-slate-100 flex items-center justify-between shrink-0">
                          ...
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-7 sm:h-8 px-2 sm:px-3 rounded-lg sm:rounded-xl text-red-600 hover:bg-red-50 font-black text-[8px] sm:text-[9px] uppercase tracking-widest"
                            onClick={() => {
