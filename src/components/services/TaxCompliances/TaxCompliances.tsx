              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3 mt-6">
                    <button className="flex-1 flex items-center justify-center gap-2 py-3 px-2 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold text-[13px] rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 shadow-lg shadow-orange-500/25 hover:shadow-orange-500/40 group">
                    ...
                    <button className="flex-1 py-3 px-2 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-[13px] rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300 shadow-md hover:shadow-xl hover:-translate-y-0.5">
                      File Now
                    </button>
                  </div>
                </div>
