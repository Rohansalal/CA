        ...
        <div className="bg-white min-h-screen">
            ...
            <section className="bg-slate-50 text-black py-20 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto px-4 relative z-10">
                    <Link to="/resources" className="inline-flex items-center gap-2 text-purple-600 hover:text-purple-700 transition-colors mb-8">
                        <ArrowLeft className="w-5 h-5" />
                        Back to Resources
                    </Link>
                    <div className="flex flex-wrap items-center gap-4 text-sm text-slate-500 mb-6">
                        <span className="px-3 py-1 bg-purple-100 text-purple-600 rounded-full border border-purple-200">Compliance</span>
